...
def print():
    ...
    dwg = svgwrite.Drawing('help_for_knitter.svg')
    dwg['width'] = '297mm'
    dwg['height'] = '210mm'    
...
def files():
    ...
    oko = Tk()
    oko.geometry('300x300')
    oko.Label(text = 'файл сохранен!', font = ('Arial', 25)).place(x = 100, y = 100)
    mainloop()
...
Button(text = 'сохранить для печати' , font = ('Arial', 10), command = print , heigh = 2 , width = 20).place(x = 0 , y = 300)
